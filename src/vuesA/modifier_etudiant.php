...
if(isset($_POST['modifie'])){
  $etudiants=recherche_etudiant();
}
else{
  $etudiants=afficher_etudiant();
...
<body id="page-top">
  ...
  <div id="wrapper">
    ...
    <!-- Begin Page Content -->
    <!-- Modal editProf -->
    <div class="modal fade" id="editEtud" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          ...
          <div class="modal-body">
            ...
            <form   method="post"   id="changeEtud" action="">
             <div class="col-md-12">
            ...
            <div class="col-md-12">
              ...
              <div class="col-md-12">
               ...
               <div class="col-md-12">
                ...
                <input type="hidden" id="mailEtudiant" name="mailEtudiant" >
              ...
              <div class="col-md-12 col-sm-12">
               <label  for="classe">  classe<span class="">*</span></label><br>
  ...
  <section id="modification">
    ...
    <div class="row">
     <div class="col-md-6 ">
      <label  for="anne">  anne</span class="">*</span></label><br>
      <select class="form-control" id="anne" name="anne">
    ...
    <div class="col-md-6">
      <label  for="classes">  classe</span class="">*</span></label><br>
      ...
      foreach($etudiants as $etudiant):
        ...
        <div class="card card-custom bg-white border-white border-0">
          ...
          <div class="card-custom-avatar">
            <img class="img-fluid" src="../../assets/pictures/img4.png" alt="Avatar" />
          </div>
          <div class="card-body" style="overflow-y: auto">
       
        <h4 class="card-title"><?= $etudiant["username_etd"]?></h4>
        <p><?= 'Nom: '.$etudiant["nom_etd"]?></p>
            <p><?= 'Prenom: '.$etudiant["prenom_etd"]?></p>
            <P>Email:</P>
            <p><?= $etudiant["email_etd"]?></p>
      </div>
      <div class="card-footer" style="background: inherit; border-color: inherit;">
            <input type="button" id="<?= $etudiant["username_etd"]?>" name="edit" value="modifier" class="btn btn-primary editEtud " data-toggle="modal" data-target="#editEtud"  >
