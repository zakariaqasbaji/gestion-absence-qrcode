...
$(document).ready(function(){
  ...
  $(form).on('submit',function(e){
    ...
    $.ajax({
      method:"POST",
      url: "../../../src/traitementA/Ajax_inserer_professeurs.php",
      data:data,
      dataType:"html",
  ...
  $("#insertEtud").on('submit',function(e){
    ...
    $.ajax({
      method:"POST",
      url: "../../../src/traitementA/Ajax_inserer_etudiants.php",
      data:data,
      dataType:"html",
      success:function(data){
        console.log(data);
...
$("#anne").on('change',function(){
  ...
  if(change) {
    ...
    $.ajax({
      method:"POST",
      url: "../../../src/traitementA/Ajax-dependent-select.php",
...
$(".editEtud").on("click",function(){
 ...
 $.ajax({
  method:"POST",
  url: "../../../src/traitementA/Ajax_info_etudiants.php",
...
$("#changeEtud").on('submit',function(e){
  ...
  $.ajax({
    method:"POST",
    url: "../../../src/traitementA/Ajax-modifier-etudiants.php",
    data:data,
    dataType:"html",
    success:function(data){
      console.log(data);
...
$(".editProf").on("click",function(){
 ...
 $.ajax({
  method:"POST",
  url: "../../../src/traitementA/Ajax_info_Professeur.php",
  data: {modif_id:modif_id},
  dataType:"html",
  success:function(data){
    console.log(data);
...
$("#changeProf").on('submit',function(e){
  ...
  $.ajax({
    method:"POST",
    url: "../../../src/traitementA/Ajax-modifier-professeur.php",
    data:data,
    dataType:"html",
    success:function(data){
      console.log(data);
